...
urlpatterns = [
    ...
    path('api/venues/modify/<str:venueCode>', modify_venue.as_view(), name='modify_venue'),
    path('api/venues/delete/<str:venueCode>', delete_venue.as_view(), name='delete_venue'),
